...
void CbcDec(HexWord* input_2, HexWord* keyScheduling, FILE *iFile, FILE *oFile) { 
    ...
    while ((byteRead = fread(buff, 1, 16, iFile)) == 16) {
        ...
        output[0].bytes[0].byte = input_2[0].bytes[0].byte ^ output[0].bytes[0].byte;
        output[0].bytes[1].byte = input_2[0].bytes[1].byte ^ output[0].bytes[1].byte;
        output[0].bytes[2].byte = input_2[0].bytes[2].byte ^ output[0].bytes[2].byte;
        output[0].bytes[3].byte = input_2[0].bytes[3].byte ^ output[0].bytes[3].byte;
        
        output[1].bytes[0].byte = input_2[1].bytes[0].byte ^ output[1].bytes[0].byte;
        output[1].bytes[1].byte = input_2[1].bytes[1].byte ^ output[1].bytes[1].byte;
        output[1].bytes[2].byte = input_2[1].bytes[2].byte ^ output[1].bytes[2].byte;
        output[1].bytes[3].byte = input_2[1].bytes[3].byte ^ output[1].bytes[3].byte;
        
        output[2].bytes[0].byte = input_2[2].bytes[0].byte ^ output[2].bytes[0].byte;
        output[2].bytes[1].byte = input_2[2].bytes[1].byte ^ output[2].bytes[1].byte;
        output[2].bytes[2].byte = input_2[2].bytes[2].byte ^ output[2].bytes[2].byte;
        output[2].bytes[3].byte = input_2[2].bytes[3].byte ^ output[2].bytes[3].byte;
        
        output[3].bytes[0].byte = input_2[3].bytes[0].byte ^ output[3].bytes[0].byte;
        output[3].bytes[1].byte = input_2[3].bytes[1].byte ^ output[3].bytes[1].byte;
        output[3].bytes[2].byte = input_2[3].bytes[2].byte ^ output[3].bytes[2].byte;
        output[3].bytes[3].byte = input_2[3].bytes[3].byte ^ output[3].bytes[3].byte;
